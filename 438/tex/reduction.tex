...
\frameans{}{
if $x \in L(P)$ then $M(x) \downarrow \text{yes}$\\
if $x \notin L(P)$ then $M(x) \downarrow \text{no}$
} 
...
\frameans{There is some machine $M$ that accepts $L(DP_2)$, in other words...}{
if $x \in L(DP_2)$ then $M(x) \downarrow \text{yes}$\\
if $x \notin L(DP_2)$ then $M(x) \downarrow \text{no}$
} 
...
From: $L(DP_2)$ is decidable, there is a Turing Machine $M_2$ that 
decides $L(DP_2)$. \\
...
% nphard
\path [name path=nphard] plot[smooth, tension=1.5] coordinates{(-14,24) (0,8) (14,24)};
...
\highlightdef{All problems in NPC are reducible to each other}
...
\begin{tikzpicture}
    ...
    % ham. path
    \draw[thick] (At) -- (1t) -- (5t) -- (9t) -- (10t) -- (6t) -- (2t) -- (3t) -- (7t) -- (11t) -- (12t) -- (8t) -- (4t) -- (Bt);
    \draw[thick] (Cf) -- (9f) -- (5f) -- (1f) -- (2f) -- (6f) -- (10f) -- (11f) -- (7f) -- (3f) -- (4f) -- (8f) -- (12f) -- (Df); 
    \end{pgfonlayer}
