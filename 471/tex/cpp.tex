...
\textit{The following frames on dynamic-binding in C\# is for optional reading.}
...
\highlightdef{\textbf{Most-derived}: The last override in a virtual-overriden chain}
If the chain has no overrides, then the most-derived is defined to be the initial virtual.
...
\highlightdef{\textbf{MI Subsumption}: Subsumption still applies for Multiple Inheritance }
