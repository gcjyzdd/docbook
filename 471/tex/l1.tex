...
inference rules have a name has a set of premisses, and one conclusion:
There can be any number of premisses (including zero), 
but there is always exactly one conclusion. 

\inference[name]{$P_1$ \\ $P_2$ \\ ... \\ $P_n$}{$Q$}
...
We define the natural numbers using a successor function. 
